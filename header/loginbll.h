...
class Login : public QQuickItem {
  Q_OBJECT
  Q_PROPERTY(
      QString usrname READ usrname WRITE setUsrname NOTIFY usrnameChanged)
  Q_PROPERTY(
      QString password READ password WRITE setPassword NOTIFY passwordChanged)
  Q_PROPERTY(bool usrLogined READ usrLogined WRITE setUsrLogined NOTIFY
                 usrLoginedChanged)
  Q_PROPERTY(bool adminLogined READ adminLogined WRITE setAdminLogined NOTIFY
                 adminLoginedChanged)
  Q_PROPERTY(QVariantList securityDB READ securityDB WRITE setSecurityDB NOTIFY
                 securityDBChanged)
public:
