...
public:
  ...
  void borrowBookDCL(const QString &book, const QString &user,
                     ...
                     int borrowedNum) override;
  void returnBookDCL(const QString &book, const QString &user, int avaiStock,
                     int borrowedNum) override;
  void addUserToDb(const QString &_id, const QString &_name,
                   const QString &_email, const QString &_type) override;
  void editUserToDb(const QString &_id, const QString &_name,
                    const QString &_email, const QString &_type) override;
