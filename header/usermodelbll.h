...
class UserModel : public QAbstractListModel {
  Q_OBJECT
  Q_PROPERTY(User *currentControlUser READ currentControlUser WRITE
                 setCurrentControlUser NOTIFY currentControlUserChanged)
  Q_PROPERTY(
      QString searcher READ searcher WRITE setSearcher NOTIFY searcherChanged)
  Q_PROPERTY(
      QQmlListProperty<User> userList READ userList NOTIFY userListChanged)
public:
  void initial(const QVariantHash &libDB);
  // Model Role Property
  enum UserModelRole { UserListRole, CurrentUserRole, RecordRole };
  ...
  Q_INVOKABLE void addUser(const QString &_id = "", const QString &_name = "",
                           const QString &_password = "",
                           const QString &_email = "",
                           const QString &_type = "user");
  Q_INVOKABLE void editUser(User *record, const QString &_name = "",
                            const QString &_password = "",
                            const QString &_email = "",
                            const QString &_type = "user");
  ...
  Q_INVOKABLE void addBook(const QString &_bookName, const QString &_author,
  ...
  Q_INVOKABLE void editBook(Book *book, const QString &_bookName,
